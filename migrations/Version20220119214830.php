 ...
 */
final class Version20220119214830 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commande ADD numc VARCHAR(50) NOT NULL, ADD totht VARCHAR(50) NOT NULL, ADD tottva VARCHAR(50) NOT NULL, ADD totttc VARCHAR(50) NOT NULL, DROP numero, CHANGE observation observation VARCHAR(50) NOT NULL, CHANGE date_commande datecomm DATE NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commande ADD numero VARCHAR(30) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP numc, DROP totht, DROP tottva, DROP totttc, CHANGE observation observation VARCHAR(30) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE datecomm date_commande DATE NOT NULL');
    }
}
